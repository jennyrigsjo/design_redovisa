...
**Håll filstorleken så liten möjligt**. Två av fyra webbplatser i analysen (Alingsås Pizzeria och Pizzeria Kvarnen) innehåller bildfiler vars storlek enligt PageSpeed Insights skulle kunna minskas ytterligare genom effektivare kodning, i vissa fall till så lite som en bråkdel av den ursprungliga filstorleken. Detta innebär givetvis inte att de som har byggt webbplatserna inte har beaktat storleken på bilderna under utvecklingen, det handlar som sagt om att uppnå *balans* mellan filstorlek och bildkvalitet och denna balans är ofta en subjektiv bedömningsfråga. Det är också värt att notera att PageSpeed flaggar en bild som komprimerbar/optimerbar om besparingspotentialen är så liten som 4 KB, och det är oklart i vilken utsträckning verktyget tar hänsyn till komprimeringens påverkan på bildkvaliteten.
